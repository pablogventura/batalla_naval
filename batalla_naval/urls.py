...
urlpatterns = [
    ...
    path(
        "partida/<int:partida_id>/ubicar_barcos/",
        bn_views.ubicar_barcos,
        name="ubicar_barcos",
    ),
    path(
        "partida/<int:partida_id>/esperando_jugadores/",
        bn_views.esperando_jugadores,
        name="esperando_jugadores",
    ),
    path(
        "partida/<int:partida_id>/esperando_turno/",
        bn_views.esperando_turno,
        name="esperando_turno",
    ),
    path(
        "partida/<int:partida_id>/ataque/",
        bn_views.elegir_enemigo,
        name="elegir_enemigo",
    ),
    path(
        "partida/<int:partida_id>/ataque/<int:jugador_id>/",
        bn_views.ataque,
        name="ataque",
    ),
    ...
    path(
        "partida/<int:partida_id>/resultados/", bn_views.resultados, name="resultados"
    ),
